...
<iframe width="100%" height="400px" src="https://app.sharefable.com/embed/demo/enable-advance-securit-os3qdqrtf25x77op" allowfullscreen />
...
<iframe width="100%" height="400px" src="https://app.sharefable.com/embed/demo/2fa-setup-method-1-bi36x4vi0oc3dm9d" allowfullscreen />
...
<iframe width="100%" height="400px" src="https://app.sharefable.com/embed/demo/2fa-setup-method-2-i1s8tmfw0wdmad6n" allowfullscreen />
...
<iframe width="100%" height="400px" src="https://app.sharefable.com/embed/demo/reset-2fa-setup-6x9s79lluyd6n2i4" allowfullscreen />
...
<iframe width="100%" height="400px" src="https://app.sharefable.com/embed/demo/allow-login-only-from-paarrbmxf9zorohb" allowfullscreen />

- Go to **Allow access only for specific IP address.**
- Click **Add IP address.**
- Not sure about your IP? Click **Autofill** to let the system detect it automatically. Alternatively, visit [whatismyip.com](http://whatismyip.com) to view your public IP address or other IPs. 
...
<iframe width="100%" height="400px" src="https://app.sharefable.com/embed/demo/set-allowed-login-time-5v27tdyoaxv7bn9i" allowfullscreen />
